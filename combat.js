...
function playCombatCard(who, cardInstance) {
  ...
  // Both sides played — move to targeting (rule 6.7). See
  // beginTargetingStep() for the assignment rule itself.
...
function startNextRound() {
  ...
  // Runs over every surviving participant, not just the two alphas —
  // a packmate's temp mods need pruning exactly the same way.
  for (const p of [...c.attackerParticipants, ...c.defenderParticipants]) {
