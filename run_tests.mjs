...
enterPhase('combat');
check('player alpha auto-selected', GameState.player.alpha === GameState.player.pack[0]);
check('opponent alpha auto-selected', GameState.opponent.alpha === GameState.opponent.pack[0]);
