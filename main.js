...
function buildCard(def, options = {}) {
  ...
  function render() {
    ...
    wrap.classList.toggle('has-cascade', wounds.length > 0);
    ...
    wrap.innerHTML = `
      <div class="card-top-row">
        ...
        ${wounds.length ? buildTuckCascade(wounds) : ''}
      </div>
...
function buildTuckCascade(wounds) {
  ...
  return `<div class="tuck-cascade">${slivers}</div>`;
}
