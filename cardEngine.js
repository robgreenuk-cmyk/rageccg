...
// damage; abilities are looked up by ITS name (e.g. "Fur Gnarl"), and
// any condition is evaluated against the victim (`target`).
function onDamageResolved(cardInstance, target) {
  for (const ab of abilitiesFor(cardInstance.name)) {
