...
function enterCombat() {
  // A forced alpha (e.g. Carla Grimsson after a failed moot) overrides the
  // normal highest-Renown auto-selection, for this Combat Phase only.
  ...
  GameState.player.alpha   = forcedPlayer   || selectBestAlpha(GameState.player.pack);
